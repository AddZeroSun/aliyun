...
export default {
  ...
  data() {
    ...
    const allowImgFormat = ['jpg', 'png', 'jpeg']
    const tempImgFormat =
  ...
  methods: {
    ...
    upload() {
      ...
      // const files = new window.File([data2blob(createImgUrl, mime)], '1-1 方图1600x1600.png', { type: file.type }, { uid: file.lastModified })
      // 监听进度回调
      ...
      this.setStep(3)
      const data = {
        file: this.dataURLtoFile(this.createImgUrl, this.fileName)
      }
